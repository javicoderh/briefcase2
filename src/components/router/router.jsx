...
<Routes> 
  ...
  <Route path="/projects" element={<ul><Link to="/stateeffect"><li>useState + useEffect</li></Link></ul>}/>  
  <Route path="/stateeffect" element={<StateEffect/>}/>
  <Route path="/devSkills" element={<DevSkillsOverview/>}>
  <Route path="/devSkills" element={<Link to="/index"><button className="homeButton"><img src="https://cdn.iconscout.com/icon/free/png-256/google-home-2981837-2476489.png" height="50"></img><h5>Home</h5></button></Link>}/>
